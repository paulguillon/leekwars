...
import { ICEBERG, LIBERATION, LIGHTNING, PROTEIN, ROCKFALL, STALACTITE } from "./common/data/chips";

/*
 * Stat : 300 agility, 400 strength, 5 MP, 18 TP, 200 resistance and 200 wisdom then full HP
