...
import { AREA_CIRCLE_1, AREA_CIRCLE_2, AREA_CIRCLE_3, AREA_FIRST_INLINE, AREA_LASER_LINE, AREA_PLUS_1, AREA_PLUS_2, AREA_PLUS_3, AREA_POINT, AREA_SQUARE_1, AREA_SQUARE_2, AREA_X_1, AREA_X_2, AREA_X_3, LAUNCH_TYPE_DIAGONAL, LAUNCH_TYPE_LINE, LAUNCH_TYPE_LINE_INVERTED, LAUNCH_TYPE_STAR, LAUNCH_TYPE_STAR_INVERTED, inArray } from "transpiler-ls";
