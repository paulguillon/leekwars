import { WEAPON_AXE, WEAPON_BAZOOKA, WEAPON_BROADSWORD, WEAPON_B_LASER, WEAPON_DARK_KATANA, WEAPON_DESTROYER, WEAPON_DOUBLE_GUN, WEAPON_ELECTRISOR, WEAPON_ENHANCED_LIGHTNINGER, WEAPON_EXPLORER_RIFLE, WEAPON_FLAME_THROWER, WEAPON_GAZOR, WEAPON_GRENADE_LAUNCHER, WEAPON_HEAVY_SWORD, WEAPON_ILLICIT_GRENADE_LAUNCHER, WEAPON_J_LASER, WEAPON_KATANA, WEAPON_LASER, WEAPON_LIGHTNINGER, WEAPON_MACHINE_GUN, WEAPON_MAGNUM, WEAPON_MYSTERIOUS_ELECTRISOR, WEAPON_M_LASER, WEAPON_NEUTRINO, WEAPON_PISTOL, WEAPON_REVOKED_M_LASER, WEAPON_RHINO, WEAPON_RIFLE, WEAPON_SHOTGUN, WEAPON_SWORD, WEAPON_UNBRIDLED_GAZOR, WEAPON_UNSTABLE_DESTROYER } from "transpiler-ls";
...
export const MACHINE_GUN: Weapon = new Weapon(
   WEAPON_MACHINE_GUN, // id
    8, // level
    2, // template
    38 // item
)
export const DOUBLE_GUN: Weapon = new Weapon(
   WEAPON_DOUBLE_GUN, // id
    45, // level
    3, // template
    39 // item
)
...
export const GRENADE_LAUNCHER: Weapon = new Weapon(
   WEAPON_GRENADE_LAUNCHER, // id
    135, // level
    7, // template
    43 // item
)
export const FLAME_THROWER: Weapon = new Weapon(
   WEAPON_FLAME_THROWER, // id
    90, // level
    8, // template
    46 // item
)
...
export const EXPLORER_RIFLE: Weapon = new Weapon(
   WEAPON_EXPLORER_RIFLE, // id
    272, // level
    24, // template
    175 // item
)
export const LIGHTNINGER: Weapon = new Weapon(
   WEAPON_LIGHTNINGER, // id
    237, // level
    25, // template
    180 // item
)
